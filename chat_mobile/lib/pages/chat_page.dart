...
class _ChatPageState extends State<ChatPage> {
  ...
  late ChatLogic chatProvider;
  late AuthLogic authProvider;

  @override
  void initState() {
    super.initState();
    chatProvider = context.read<ChatLogic>();
    authProvider = context.read<AuthLogic>();
  ...
  void onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      //     msg: 'Nothing to send', backgroundColor: Colors.grey);
       SnackBar(content: Text('Nothing to send', style: TextStyle(color: Colors.grey),));
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        //   IconButton(
        //     onPressed: () {
        //       ProfileLogic profileProvider;
        //       profileProvider = context.read<ProfileLogic>();
